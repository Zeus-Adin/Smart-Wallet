...
const WalletHeader = ({
  ...
  const handleNetworkSwitch = (network: 'mainnet' | 'testnet') => {
    // Disconnect wallet when switching networks to ensure state consistency
    disconnectWallet();
              ...
              <CardContent className="px-3 py-2 md:px-4">
                <div className="flex items-center space-x-2 md:space-x-4">
                  <div className="text-right">
                    <div className="text-xs md:text-sm text-slate-400">Balance</div>
                    <div className="text-sm md:text-lg font-bold text-white">{currentWallet.balance}</div>
                  </div>
