  ...
  return (
    <WalletLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Send Assets</h1>
          <p className="text-slate-400">Transfer your tokens or NFTs to another wallet or smart contract.</p>
          {selectedWallet && (
