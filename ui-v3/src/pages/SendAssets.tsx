  ...
  return (
    <WalletLayout>
      <div className="space-y-6">
        <div className="px-1">
          <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">Send Assets</h1>
          <p className="text-slate-400 text-sm sm:text-base">Transfer your tokens or NFTs to another wallet or smart contract.</p>
          {selectedWallet && (
        ...
        <Card className="bg-slate-800/50 border-slate-700 mx-1 sm:mx-0">
          <CardHeader className="px-4 sm:px-6">
            <CardTitle className="text-white flex items-center text-lg sm:text-xl">
              ...
              <span className="break-words">{getStepTitle(currentStep, assetType)}</span>
            </CardTitle>
          </CardHeader>
